...
Alist Magisk 模块将 [Alist](https://github.com/AlistTeam/Alist) 文件服务器集成到 Android 系统中，通过 Magisk 以系统化方式运行，支持 ARM 和 ARM64 架构。
...
1. **下载模块**
   - 从 [GitHub Releases](https://github.com/Alien-Et/Alist-Magisk/releases) 下载最新版本
...
- 问题反馈：[GitHub Issues](https://github.com/Alien-Et/Alist-Magisk/issues)
